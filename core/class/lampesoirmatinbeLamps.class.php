...
class lampesoirmatinbeLamps {
    ...
    public static function classify($_name, $_cmds, $_objectName = '') {
        ...
        /*
         * Sans de quoi allumer ni de quoi éteindre, ce n'est pas une lampe.
         * Un équipement qui n'a qu'une bascule en est une malgré tout : beaucoup
         * d'interrupteurs muraux ne savent faire que ça, et le plugin s'en
         * servira pour les deux ordres — au risque assumé d'inverser l'état si
         * la lampe a été touchée à la main entre-temps, ce que la documentation
         * dit sans détour.
         */
        if ($found['on'] === null && $found['off'] === null && $found['toggle'] === null) {
            return null;
        }
        if ($confidence === null) {
            $confidence = self::GUESS;
