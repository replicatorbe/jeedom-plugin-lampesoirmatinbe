 ...
 */
?>
<div id="div_lampesoirmatinbePicker">
	...
	<div class="row" style="margin:0 0 10px 0;">
		<div class="col-sm-6" style="padding-left:0;">
			<div class="input-group">
				...
				<input type="text" class="form-control roundedRight" id="in_lampesoirmatinbeSearch" placeholder="{{Filtrer par nom de lampe ou de pièce}}">
			</div>
		</div>
		<div class="col-sm-6 text-right" style="padding-right:0;">
			<div class="btn-group">
				<a class="btn btn-sm btn-default active lsmFilter" data-filter="light"><i class="fas fa-lightbulb"></i> {{Lampes}} <span class="badge" data-count="light">0</span></a>
				<a class="btn btn-sm btn-default active lsmFilter" data-filter="plug"><i class="fas fa-plug"></i> {{Prises}} <span class="badge" data-count="plug">0</span></a>
				<a class="btn btn-sm btn-default active lsmFilter" data-filter="guess"><i class="fas fa-question"></i> {{Autres}} <span class="badge" data-count="guess">0</span></a>
				<a class="btn btn-sm btn-default lsmFilter" data-filter="unknown" title="{{Montre tous les équipements qui portent une commande d'action}}"><i class="fas fa-th-list"></i> {{Tous les équipements}} <span class="badge" data-count="unknown">0</span></a>
			</div>
		</div>
	</div>

	<div id="div_lampesoirmatinbePickerList" style="max-height:55vh;overflow:auto;">
	...
	<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:10px;padding-top:10px;">
		<span id="span_lampesoirmatinbePickerCount" class="label label-info">0 {{sélectionnée(s)}}</span>
		<span class="pull-right">
			<a class="btn btn-default" id="bt_lampesoirmatinbePickerCancel">{{Annuler}}</a>
			<a class="btn btn-success" id="bt_lampesoirmatinbePickerValidate"><i class="fas fa-check"></i> {{Valider la sélection}}</a>
		</span>
	</div>
</div>
